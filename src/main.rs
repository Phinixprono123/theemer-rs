...
#[command(
    name = "theemer-rs",
    version,
    about = "change the theme of any images"
)]
struct Args {
    // Input image path
    input_file: PathBuf,
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    output
        ...
        .map_err(|e| format!("Failed to save output image to '{:?}': {}", args.output_file, e))?;
...
fn get_builtin_palette(theme: BuiltinTheme) -> Vec<[u8; 3]> {
    match theme {
        BuiltinTheme::Nord => vec![
            [25, 29, 36], [30, 34, 42], [34, 38, 48], [36, 41, 51],
            [46, 52, 64], [59, 66, 82], [67, 76, 94], [76, 86, 106],
            [96, 114, 138], [192, 200, 216], [187, 195, 212], [216, 222, 233],
            [229, 233, 240], [236, 239, 244], [94, 129, 172], [129, 161, 193],
            [136, 192, 208], [143, 188, 187], [159, 198, 197], [128, 179, 178],
            [191, 97, 106], [197, 114, 122], [183, 78, 88], [208, 135, 112],
            [215, 151, 132], [203, 119, 93], [235, 203, 139], [239, 212, 159],
            [231, 193, 115], [163, 190, 140], [177, 200, 157], [151, 182, 124],
            [180, 142, 173], [190, 157, 184], [169, 126, 161],
        ],
        BuiltinTheme::Gruvbox => vec![
            [29, 32, 33], [40, 40, 40], [50, 48, 47], [60, 56, 54],
            [80, 73, 69], [102, 92, 84], [124, 111, 100], [146, 131, 116],
            [249, 245, 215], [251, 241, 199], [242, 229, 188], [235, 219, 178],
            [213, 196, 161], [189, 174, 147], [168, 153, 132], [251, 73, 52],
            [184, 187, 38], [250, 189, 47], [131, 165, 152], [211, 134, 155],
            [142, 192, 124], [254, 128, 25], [204, 36, 29], [152, 151, 26],
            [215, 153, 33], [69, 133, 136], [177, 98, 134], [104, 157, 106],
            [214, 93, 14], [157, 0, 6], [121, 116, 14], [181, 118, 20],
            [7, 102, 120], [143, 63, 113], [66, 123, 88], [175, 58, 3],
        ],
    }
}
